...
public class DevInitData {
    ...
    public CommandLineRunner initData(MemberService memberService, ProductService productService, CartService cartService,
        ...
        return args -> {
            ...
            Product product1 = productService.create("단가라 OPS", 68000, 45000,"청평화 A-1-15",
                    Arrays.asList(new ProductOption("RED", "44"), new ProductOption("RED", "44"),
                            new ProductOption("BLUE", "44"), new ProductOption("BLUE", "44")));
            Product product2 = productService.create("쉬폰 OPS", 72000, 55000,"청평화 A-1-15",
                    Arrays.asList(new ProductOption("WHITE", "44"), new ProductOption("WHITE", "44"),
                            new ProductOption("BLACK", "44"), new ProductOption("BLACK", "44")));
